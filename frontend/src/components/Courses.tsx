function Courses() {
    return (
        <>
            <section id="cursos" className="scroll-mt-18 sm:scroll-mt-28 xl:w-7xl mt-15 mx-auto sm:w-full">
                ...
                <div className="grid lg:grid-cols-3 gap-x-3 lg:w-3xl mx-auto sm:w-xl sm:grid-cols-1">
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        <h3 className="bg-yellow-200 w-fit font-bold rounded-2xl lg:p-1 border-black border-2 sm:p-2">ReactiveX - RxJs: De cero hasta los detalles</h3>
                        <div className="mt-3 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 sm:p-2">(9 horas)</div>
                    ...
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        <h3 className="bg-yellow-200 w-fit font-bold rounded-2xl lg:p-1 border-black border-2 sm:p-2">JavaScript Algorithms and Data Structures</h3>
                        <div className="mt-3 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 sm:p-2">(300 horas)</div>
                        <div className="mt-3 bg-white w-fit p-1 rounded-2xl border-2 border-black">
                    ...
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        <h3 className="bg-yellow-200 w-fit font-bold rounded-2xl lg:p-1 border-black border-2 sm:p-2">Responsive Web Design</h3>
                        <div className="lg:mt-10 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 sm:p-2 sm:mt-3">(300 horas)</div>
