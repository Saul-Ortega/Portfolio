function Experience() {
    ...
    return(
        <>
            <section id="experiencia" className="scroll-mt-18 xs:scroll-mt-20 sm:scroll-mt-28 xl:w-7xl mt-15 mx-auto sm:w-full 2xs:w-md xs:xs:w-80">
                ...
                <ul className="mt-5 lg:w-3xl mx-auto relative border-l-black border-l-4 sm:w-xl">
                    <li>
                        <div className="bg-yellow-200 border-2 border-black absolute size-5 rounded-full -ml-3 sm:mt-51 sm:mb-51 xs:mt-68 xs:mb-68 2xs:mt-55 2xs:mb-55 lg:mt-41 lg:mb-41"></div>
