function Courses() {
    return (
        <>
            <section id="cursos" className="scroll-mt-18 sm:scroll-mt-28 md:w-7xl mt-15 mx-auto sm:w-full">
                ...
                <div className="grid md:grid-cols-3 gap-x-3 md:w-3xl mx-auto sm:w-xl sm:grid-cols-1">
                    <div className="bg-yellow-200/60 mt-5 md:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
