function Experience() {
    ...
    return(
        <>
            <section id="experiencia" className="scroll-mt-18 xs:scroll-mt-20 sm:scroll-mt-28 xl:w-7xl mt-15 mx-auto sm:w-full xs:w-md">
                <h2 className="bg-violet-600/60 border-black border-2 w-fit p-2 text-4xl text-center rounded-2xl xs:mx-auto">Experiencia</h2>
                <ul className="mt-5 lg:w-3xl mx-auto relative border-l-black border-l-4 sm:w-xl">
                    <li>
                        <div className="bg-yellow-200 border-2 border-black absolute size-5 rounded-full -ml-3 sm:mt-51 sm:mb-51 xs:mt-55 xs:mb-55 lg:mt-41 lg:mb-41"></div>
                        <div className="lg:ml-20 bg-yellow-200/60 w-fit p-6 border-black border-2 rounded-2xl sm:ml-10 xs:ml-5">
                            ...
                            <div className="mt-3 w-fit bg-white border-2 border-black rounded-2xl lg:p-2 xs:p-3">
                                ...
                                <div className="lg:mt-1 xs:mt-2">Las Palmas de Gran Canaria</div>
                            </div>
                            <div className="mt-3 bg-white border-2 border-black rounded-2xl lg:p-2 xs:p-3">
