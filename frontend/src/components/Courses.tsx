            ...
            <section id="cursos" className="scroll-mt-18 xs:scroll-mt-20 sm:scroll-mt-28 xl:w-7xl mt-15 mx-auto sm:w-full 2xs:w-md xs:w-80">
                ...
                <div className="grid lg:grid-cols-3 gap-x-3 lg:w-3xl mx-auto sm:w-xl 2xs:grid-cols-1">
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        ...
                        <div className="mt-3 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 xs:p-2 selection:bg-violet-400">(9 horas)</div>
                    ...
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        ...
                        <div className="mt-3 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 xs:p-2 selection:bg-violet-400">(300 horas)</div>
                        <div className="mt-3 bg-white w-fit p-1 rounded-2xl border-2 border-black">
                    ...
                    <div className="bg-yellow-200/60 mt-5 lg:w-full p-6 border-2 border-black rounded-2xl flex flex-col justify-center items-center sm:w-md sm:mx-auto">
                        ...
                        <div className="lg:mt-10 bg-violet-200 w-fit lg:p-1 rounded-2xl border border-violet-700 xs:p-2 xs:mt-3 selection:bg-violet-400">(300 horas)</div>
