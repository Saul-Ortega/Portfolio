        ...
        <>
            <section id="proyectos" className="scroll-mt-18 sm:scroll-mt-28 md:w-7xl mt-15 mx-auto sm:w-full">
                ...
                <div className="mt-5 bg-yellow-200/60 md:w-3xl p-6 border-2 border-black rounded-2xl mx-auto sm:w-xl">
                    ...
                    <img src="public/images/MatchesAPI-screenshot.png" alt="Captura de pantalla del proyecto MatchesAPI" className="mt-3 bg-white w-90 md:p-2 border-black border-2 rounded-2xl mx-auto sm:p-3" />
                ...
                <div className="bg-yellow-200/60 mt-5 md:w-3xl p-6 border-2 border-black rounded-2xl mx-auto sm:w-xl">
                    ...
                    <video src="./public/videos/sportium-video.mov" controls className="mt-3 bg-white w-fit md:p-2 border-black border-2 rounded-2xl mx-auto sm:p-3"></video>
                    <div className="mt-3 flex flex-row justify-evenly items-center p-2 bg-white w-fit h-20 border-black border-2 rounded-2xl mx-auto">
                ...
                <div className="bg-yellow-200/60 mt-5 md:w-3xl p-6 border-2 border-black rounded-2xl mx-auto sm:w-xl">
                    ...
                    <img src="./public/images/MatchesWEB.png" alt="Captura de pantalla del proyecto MatchesWEB" className="mt-3 bg-white w-fit md:p-2 border-black border-2 rounded-2xl mx-auto sm:p-3" />
                    <div className="mt-3 flex flex-row justify-evenly items-center p-2 bg-white w-fit h-20 border-black border-2 rounded-2xl mx-auto">
