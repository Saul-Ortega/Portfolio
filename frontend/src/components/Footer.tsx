function Footer() {
    ...
    return(
        <>
            <footer id="contacto" className="scroll-mt-18 sm:scroll-mt-28 md:w-7xl mt-15 mb-15 mx-auto sm:w-full">
                <h2 className="bg-violet-600/60 border-black border-2 w-fit p-2 text-4xl text-center rounded-2xl sm:mx-auto">Contacto</h2>
                <div className="bg-yellow-200/60 md:w-3xl p-6 border-black border-2 rounded-2xl mx-auto mt-5 sm:w-xl">
